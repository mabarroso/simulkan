...
module Simulkan
  class Getkanban < Scenario
    ...
    def build_cards
      ...
      @cards << Card.new('s1' , service_class: Card::CLASS_NORMAL    , columns_points: [  0,   0,  11], attributes: {subs: 11, money:    0} ) #  1 (test)
      @cards << Card.new('s2' , service_class: Card::CLASS_NORMAL    , columns_points: [  0,   0,  12], attributes: {subs: 12, money:    0} ) #  1 (test)
      @cards << Card.new('s3' , service_class: Card::CLASS_NORMAL    , columns_points: [  0,   0,  11], attributes: {subs: 11, money:    0} ) #  1 (test)
      @cards << Card.new('s4' , service_class: Card::CLASS_NORMAL    , columns_points: [  0,   0,  11], attributes: {subs: 10, money:    0} ) #  2 (dev done)
      @cards << Card.new('s5' , service_class: Card::CLASS_NORMAL    , columns_points: [  0,   0,  13], attributes: {subs: 13, money:    0} ) #  2 (dev done)
      @cards << Card.new('s6' , service_class: Card::CLASS_NORMAL    , columns_points: [  0,   8,  12], attributes: {subs: 11, money:    0} ) #  3 (dev doing)
      @cards << Card.new('s7' , service_class: Card::CLASS_NORMAL    , columns_points: [  0,  13,  14], attributes: {subs: 12, money:    0} ) #  3 (dev doing)
      @cards << Card.new('s8' , service_class: Card::CLASS_NORMAL    , columns_points: [  0,   9,  14], attributes: {subs: 10, money:    0} ) #  3 (Design done)
      @cards << Card.new('s9' , service_class: Card::CLASS_NORMAL    , columns_points: [  6,  13,  15], attributes: {subs: 12, money:    0} ) #  4 (Design doing)
      @cards << Card.new('s10', service_class: Card::CLASS_NORMAL    , columns_points: [ 10,  10,  12], attributes: {subs: 11, money:    0} ) #  4 (Design doing)
      @cards << Card.new('s11', service_class: Card::CLASS_NORMAL    , columns_points: [ 12,  11,  15], attributes: {subs: 13, money:    0} ) #  5 (Ready)
      @cards << Card.new('s12', service_class: Card::CLASS_NORMAL    , columns_points: [  7,  10,  13], attributes: {subs: 10, money:    0} ) #  6 (Ready)
      @cards << Card.new('s13', service_class: Card::CLASS_NORMAL    , columns_points: [  8,  11,  12], attributes: {subs: 10, money:    0} ) #  6 (Ready)
      @cards << Card.new('s14', service_class: Card::CLASS_NORMAL    , columns_points: [  7,  11,  11], attributes: {subs: 10, money:    0} ) #  7 (Ready)
      @cards << Card.new('s15', service_class: Card::CLASS_NORMAL    , columns_points: [  5,   9,   8], attributes: {subs:  7, money:    0} ) #  8 (Ready)
      ...
      @cards << Card.new('i1' , service_class: Card::CLASS_INTANGIBLE, columns_points: [  0,   5,  11], attributes: {subs:  0, money:    0} ) #   3 (Dev doing)
      @cards << Card.new('i2' , service_class: Card::CLASS_INTANGIBLE, columns_points: [  1,  13,   6], attributes: {subs:  0, money:    0} ) #   8 (Ready)
